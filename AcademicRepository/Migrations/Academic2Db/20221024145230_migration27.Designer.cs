...
namespace _2022_09_23.Migrations.Academic2Db
{
    ...
    [Migration("20221024145230_migration27")]
            ...
            modelBuilder.Entity("_2022_09_23.Entities.SubjectTeacher", b =>
                {
                    ...
                    b.Property<int>("TeacherId_FK")
                        .HasColumnType("int");

                    b.Property<int>("Id")
                        .HasColumnType("int");

                    b.HasKey("SubjectId_FK", "TeacherId_FK");

                    b.HasIndex("TeacherId_FK");
            ...
            modelBuilder.Entity("_2022_09_23.Entities.SubjectTeacher", b =>
                {
                    b.HasOne("_2022_09_23.Entities.Subject", "Subject")
                        .WithMany("Teachers")
                        .HasForeignKey("SubjectId_FK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_2022_09_23.Entities.Teacher", "Teacher")
                        .WithMany("Subjects")
                        .HasForeignKey("TeacherId_FK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
